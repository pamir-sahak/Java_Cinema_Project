...
/***
 * The controller for buying ticket page
...
public class BuyTicketController implements Initializable {
	...
	/***
	 * these methods sends user to new pages such as main page and booking history page
	...
	@FXML
	private void showSelectedFilm(ActionEvent event){
		try {
